...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'song': case 'video': {
                ...
                let buttons = [
                    ...
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '📽️ Video️'}, type: 1}
                ]
                let buttonMessage = {
...
case 'webtonsearch': case 'webtoon':
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
            ...
            case 'twittermp3x': case 'twitteraudiox': {
                ...
                let anu = await fetchJson(api('zenz', '/api/downloader/twitter', { url: text }, 'apikey'))
                let buttons = [
                    {buttonId: `twitter ${text}`, buttonText: {displayText: '📽️ Video️'}, type: 1}
                ]
                let buttonMessage = {
		...
		if (anu.type == 'video') {
		    let buttons = [
                        ...
                        {buttonId: `ytmp4 ${anu.media[0]} 360p`, buttonText: {displayText: '📽️ Video️'}, type: 1}
                    ]
		    let buttonMessage = {
