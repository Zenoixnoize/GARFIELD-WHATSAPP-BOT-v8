...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` GARFIELD `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./TempCloud/logo.png`),"sourceUrl": "https://i.ibb.co/cDRqN7C/IMG-20220601-230700-700.png"}}}, { quoted: m})
        }
...
```URL``` : *${anu.url}*`,
                    ...
                    buttons: buttons,
                    headerType: 4
                    hydratedFooterText: `© ᴄᴏᴅᴇᴅ ʙʏ ᴛʜᴀʀɪɴᴅᴜ ʟɪʏᴀɴᴀɢᴇ`
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'developer': case 'donate': case 'owner': case 'project': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/cDRqN7C/IMG-20220601-230700-700.png' }, caption: ` - Hi 🥰 I m \n ＮＯＩＺ Ξ \n I am 16 years old developer... \n From Sri Lanka 🇱🇰 \n I am a Learning. \n Not more.. \nAlso I am Student ` }, { quoted: m })
            }
            break
    ...
    const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./TempCloud/logo.png')},
                            hydratedFooterText: `User ${pushname}`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube 🐼 ',
                                    url: `${myweb}`
...
*┃╠ 🐼 delvote*
 ┃╚ 
 ┗━━「 ${pushname} 」━ 🐼`,unicorn, [{"urlButton": {"displayText": "Follow Us ℹ️ ","url": `${myweb}`}},{"urlButton": {"displayText": "Script 🍿 ","url": `${sc}`}},{"quickReplyButton": {"displayText": "❄️Donate❄️","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Developer 👤","id": 'owner'}}] )
break
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `       
*Helpers 🌹*\n*☘️ Hasindu Dinushan*\n*☘️ Lasindu Nethsara*\n*☘️ Maleesha Nethsara*\n*☘️ Farhan*\n*☘️ Atticus*\n*☘️ Yusufusta*
*User -*「 ${pushname} 」━ 🐼`,unicorn, [{"urlButton": {"displayText": "Follow Us ℹ️ ","url": `${myweb}`}},{"urlButton": {"displayText": "Script 🍿 ","url": `${sc}`}},{"quickReplyButton": {"displayText": "❄️Donate❄️","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Developer 👤","id": 'owner'}}] )
break
...
And Again Me (NOIZE DEVELOPMENT) 🐼 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Follow Us ℹ️ ","url": `${myweb}`}},{"urlButton": {"displayText": "Script 🍿 ","url": `${sc}`}},{"quickReplyButton": {"displayText": "❄️Donate❄️","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Developer 👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
