...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `*Garfield Whatsapp Bot by NOIZE DEV*\n*Version - v8.0*\n*Coded by Tharindu Liyanage*\n*🐣 24×7 Online whatsapp  Bot*\n*Powered by Xnodes server 🚀*\n*Update Logs*\n*Button update, WAWeb module Update   and more*\n*Special Thanks to 🌹❤️ -*\n*Hasindu , Lasindu ,Maleesha,Afnan,Farhan,Atticus* `,unicorn, [{"urlButton": {"displayText": "Follow Us ℹ️ ","url": `${myweb}`}},{"urlButton": {"displayText": "Script 🌈","url": `${sc}`}},{"quickReplyButton": {"displayText": "Donate 🚀","id": 'donate'}},{"quickReplyButton": {"displayText": "Developer 🦋","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
