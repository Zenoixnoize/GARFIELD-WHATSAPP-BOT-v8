...
case 'webtonsearch': case 'webtoon':
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply('Your Daily Limit Has Expired')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (!id) return reply(`No Query username, Example : ${prefix + command} ig liyanage_tharindu_`)
          ...
          listType: 1
            ...
            break
             case 'owner': case 'donate':  {
                GarfieldAdd.sendMessage(m.chat, { image: { url: global.thumb }, caption: `${global.notice}` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
...
break
case 'make': case 'creat': case 'projsct':
var unicorn = await getBuffer(picak)
await GarfieldAdd.send5ButImg(from, `` + '' + ' ', `
𝖢𝖱𝖤𝖠𝖳 𝖮𝖶𝖭 𝖡𝖮Т 𝖤𝖠𝖲𝖨𝖫𝖸
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 01 - Creat Heroku Account
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 02 - Fork Garfield v8.2 Repo
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 03 - Scan Qr and Linked Your Device 
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 04 - Replace Your session file
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 05 - Modify the config file as you wish and enter your bot's name and details
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 04 - Creat Heroku Account 
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 05 - After Click Deploy button 
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 06 - Enter Your app name and click deploy now button 
▰▰▰▰▰▰▰▰▰▰▰▰▰
🦋 Step 07 - Then wait forty seconds for the process to take place
▰▰▰▰▰▰▰▰▰▰▰▰▰
 Enjoy Now 💙  `,unicorn, [{"urlButton": {"displayText": "Creat Github Account 🐻️","url": `https://github.com/signup?source=login`}},{"urlButton": {"displayText": "Creat Heroku Account 🌻","url": `https://github.com/signup?source=login`}},{"urlButton": {"displayText": "𝖦Λ𝖱𝖥𝖨Ξ𝖫𝖣 𝖡𝖮Т v8.3 🐼","url": `https://github.com/Zenoixnoize/GARFIELD-WHATSAPP-BOT-v8`}},{"quickReplyButton": {"displayText": "Donate 🚀","id": 'donate'}},{"quickReplyButton": {"displayText": "Developer 🦋","id": 'dev'}}] )
break
