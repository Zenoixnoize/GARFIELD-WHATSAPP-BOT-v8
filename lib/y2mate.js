...
module.exports = {
  ...
  ytIdRegex,
  //Coded by Tharindu Liyanage
  yta(url, resol = '320kbps', server = 'bn323') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  //Coded by Tharindu Liyanage
  ytv(url, resol = '360p', server = 'fr239') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) },
