...
module.exports = {
  ...
  yta(url, resol = '128kbps', server = 'en316') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  
  ytv(url, resol = '360p', server = 'en320') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) },
  servers: ['en371']
}
