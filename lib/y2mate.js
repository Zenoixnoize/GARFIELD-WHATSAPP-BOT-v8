...
async function yt(url, quality, type, bitrate, server = 'en316') {
...
module.exports = {
  ...
  yta(url, resol = '128kbps', server = 'en277') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  servers: ['en371','vi278','vi280','vi294'],
  
  ytv(url, resol = '360p', server = 'en371') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) },
  servers: ['en371','en320','en277']
}
