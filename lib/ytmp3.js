...
module.exports = {
  ...
  tharinduaudio(url, resol = '320kbps', server = 'en316') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  servers:  ['en277'],
  
  ytv(url, resol = '360p', server = 'en316') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) },
  servers: ['en316','de223','bn232','ph237','en316'],
}
