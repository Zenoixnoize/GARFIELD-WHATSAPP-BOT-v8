...
async function yt(url, quality, type, bitrate, server = 'en320') {
  ...
  let res2 = await post(`https://www.y2mate.com/mates/en316/convert`, {
    type: 'youtube',
    _id: id[1],
    v_id: ytId[1],
    ajax: '1',
...
module.exports = {
  ...
  tharinduaudio(url, resol = '320kbps', server = 'en320') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  servers:  ['en316','en371','en277']
}
