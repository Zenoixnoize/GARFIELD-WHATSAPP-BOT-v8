...
async function yt(url, quality, type, bitrate, server = 'en393') {
...
module.exports = {
  ...
  yta(url, resol = '320kbps', server = 'en393') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  servers: ['en393','en393','en393','en393'],
