...
module.exports = GarfieldNeural = async (GarfieldNeural, m, chatUpdate, store) => {
    try {
	    ...
	    } else global.db.data.Config[botNumber] = {
		status: 0,
		autobio: false,
	    }
	...
	//group target \\
const reply = (teks) => {
            GarfieldNeural.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` 𝖦Λ𝖱𝖥𝖨Ξ𝖫𝖣 𝖡𝖮Т`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./TempCloud/logo.png`),"sourceUrl": "https://telegra.ph/file/8bbe8a7de5c351dfcb077.jpg"}}}, { quoted: m})
        }
